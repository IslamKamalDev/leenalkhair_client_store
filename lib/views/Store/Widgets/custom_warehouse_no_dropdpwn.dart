...
class CustomWarehouseNoDropDown extends StatefulWidget {
  String? hint;
  bool? select_city_status;
  bool? cities_depend_region_status;
  String? city_name;
  CustomWarehouseNoDropDown({this.hint,this.select_city_status = false,this.city_name});
  @override
  _CustomWarehouseNoDropDownState createState() => _CustomWarehouseNoDropDownState();
}

class _CustomWarehouseNoDropDownState extends State<CustomWarehouseNoDropDown> {
