...
class CustomSupplierNameDropDown extends StatefulWidget {
  String? hint;
  bool? select_city_status;
  bool? cities_depend_region_status;
  String? city_name;
  CustomSupplierNameDropDown({this.hint,this.select_city_status = false,this.city_name});
  @override
  _CustomSupplierNameDropDownState createState() => _CustomSupplierNameDropDownState();
}

class _CustomSupplierNameDropDownState extends State<CustomSupplierNameDropDown> {
    ...
    return   Container(
          child: Form(
            ...
            child: DropdownSearch<UserModel>(
              ...
              onChanged: (user){
                Shared.supplier_name = user!.name;
              },
