...
class CustomInvoiceIdDropDown extends StatefulWidget {
  String? hint;
  bool? select_city_status;
  bool? cities_depend_region_status;
  String? city_name;
  CustomInvoiceIdDropDown({this.hint,this.select_city_status = false,this.city_name});
  @override
  _CustomInvoiceIdDropDownState createState() => _CustomInvoiceIdDropDownState();
}

class _CustomInvoiceIdDropDownState extends State<CustomInvoiceIdDropDown> {
